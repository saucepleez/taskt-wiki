...
|Please indicate the workbook file path (ex. C:\temp\myfile.xlsx, {vFilePath})|Enter or Select the path to the applicable file that should be opened by Excel.|**C:\temp\myfile.xlsx** or **{vFilePath}**||
