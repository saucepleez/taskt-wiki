...
|Please Enter the target worksheet name (ex. mySheet, {vSheet})||**mySheet** or **{vSheet}**|Failure to enter the correct instance name or failure to first call **Create Excel** command will cause an error|
|Please Enter the new worksheet name (ex. newMySheet, {vNewName})||**newMySheet** or **{vNewName}**|Failure to enter the correct instance name or failure to first call **Create Excel** command will cause an error|
