...
<dt>Error Occurs When the Value is ...</dt><dd><ul>
<li>Empty</li>
</ul></dd><dt>Sample Usage</dt><dd><strong>mySheet</strong> or <strong>Current Sheet</strong> or <strong>{vSheet}</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
...
<dt>Error Occurs When the Value is ...</dt><dd><ul>
<li>Empty</li>
</ul></dd><dt>Sample Usage</dt><dd><strong>Name</strong> or  <strong>Visible</strong> or  <strong>Is first sheet</strong> or  <strong>Is last sheet</strong> or  <strong>Next sheet</strong> or  <strong>Previous sheet</strong> or  <strong>Sheet index</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
