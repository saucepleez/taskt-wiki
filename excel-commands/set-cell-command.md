...
|Please Enter text to set (ex. Hello, {vText})|Enter the text value that will be set.|**Hello World** or **{vText}**||
|Please Enter the Cell Location (ex. A1, {vAddress})|Enter the actual location of the cell.|**A1** or **B10** or **{vAddress}**||
