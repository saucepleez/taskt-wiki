...
- [Please Select the Please specify a Variable to store XML](#param_1)
...
<a id="param_1"></a>
### Please Select the Please specify a Variable to store XML
...
<li>Empty</li>
</ul></dd><dt>Sample Usage</dt><dd><strong>vXML</strong> or <strong>{vXML}</strong></dd>
