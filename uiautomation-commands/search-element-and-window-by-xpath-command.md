<!--TITLE: Search Element And Window By XPath Command -->
<!-- SUBTITLE: a command in the UIAutomation Commands group. -->
[Go To Automation Commands Overview](/automation-commands.md)


UIAutomation Commands &gt; Search Element & Window &gt; Search Element And Window By XPath


# Search Element And Window By XPath Command
...
- [Optional - Please Specify the Wait Time for the AutomationElement to Exist (sec)](#param_7)
...
Automation Class Name: UIAutomationSearchElementAndWindowByXPathCommand
