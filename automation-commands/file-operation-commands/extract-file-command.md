...
| ---                    | ---               | ---           | ---       |
|Please enter the file location (https:// is supported)|Enter or Select the path to the applicable file or enter file URL.|C:\temp\myfile.zip , [vFilePath] or https://temp.com/myfile.zip||
|Please indicate the extraction folder (ex. C:\temp\myzip\|Enter or Select the path to the applicable file or enter file URL.|C:\temp\ or {vFilePath}||
|Optional - Indicate the archive password|L.|mypass or {vPass}||
