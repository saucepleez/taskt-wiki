...
## Command Parameters
- [Close After X (Seconds) - 0 to bypass](#param_0)
...
<dt>Sample Data</dt><dd><strong>0</strong> to remain open indefinitely or <strong>5</strong> to stay open for 5 seconds.</dd>
