...
- [Please Specify the Variable Name To Assign The DataTable](#param_2)
...
<dt></dt><dd></dd>
<dt>Sample Data</dt><dd><strong>0</strong> or <strong>1</strong> or <strong>-1</strong> or <strong>{vRowIndex}</strong></dd>
