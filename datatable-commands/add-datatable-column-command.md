...
<dt>Error When Value is ...</dt><dd><ul>
<li>Empty</li>
</ul></dd><dt>Sample Data</dt><dd><strong>newColumn</strong> or <strong>{vNewColumn}</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
...
<dt>Sample Data</dt><dd><strong>Error</strong> or <strong>Ignore</strong> or <strong>Replace</strong></dd>
