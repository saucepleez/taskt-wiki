...
## Command Parameters
- [Please Specify the Specify the path of the file you want to check for existence](#param_0)
- [Please Select the Specify the variable to assign the result](#param_1)
- [Please Specify the Comment Field (Optional)](#param_2)


<a id="param_0"></a>
### Please Specify the Specify the path of the file you want to check for existence
...
<li>Empty</li>
</ul></dd><dt>Sample Usage</dt><dd><strong>C:\temp\myfile.txt</strong> or <strong>{vFilePath}</strong></dd>
