...
|Specify required output format (ex. yy/MM/dd, hh:mm, #.0, file)|Specify if a specific string format is required.|MM/dd/yy, hh:mm, C2, D2, file, folder, extension etc.||
