...
| ---                    | ---               | ---           | ---       |
|Please supply the input to be computed (ex. (2 + 1), {vNum}+1)|Specify either text or a variable that contains valid math.|2+1, {vNum}+1|You can use known numbers or variables.|
