...
| ---                    | ---               | ---           | ---       |
|Please indicate the PDF file path or PDF file URL (ex. c:\temp\myfile.pdf, {vPDFPath})|Enter or Select the path to the applicable file or enter file URL.|C:\temp\myfile.pdf , {vFilePath} or https://temp.com/myfile.pdf||
