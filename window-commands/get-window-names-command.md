...
| ---                    | ---               | ---           | ---       |
|Please enter or select the window name that you want to.|Input or Type the name of the window name that you want to.|**Untitled - Notepad** or **Current Window** or **{vWindow}**||
