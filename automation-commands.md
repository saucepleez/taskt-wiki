...
|Data Commands|[Get Word Count](/automation-commands/data-commands/get-word-count-command.md)|This command allows you to you to retrieve the word count of a string or variable.|
...
|Input Commands|[Send Hotkey](/automation-commands/input-commands/send-hotkey-command.md)|Sends keystrokes to a targeted window|
...
|Misc Commands|[Ping Command](/automation-commands/misc-commands/ping-command-command.md)|This command allows you to add an in-line comment to the script.|
...
|Web Browser Commands|[Take Screenshot](/automation-commands/web-browser-commands/take-screenshot-command.md)|This command allows you to take a screenshot in Selenium web browser session.|
### Window Commands
| Command Group   	| Command Name 	|  Command Description	|
| ---                | ---           | ---                   |
