...
|Specify a JSON extractor (JSONPath)|Input a JSON token extractor|**$.id**||
|Please select the variable to receive the extracted Result|Select or provide a variable from the variable list|**vSomeVariable**|If you have enabled the setting **Create Missing Variables at Runtime** then you are not required to pre-define your variables, however, it is highly recommended.|
