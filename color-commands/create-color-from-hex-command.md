...
- [Please Specify the Please specify Color HEX Value](#param_1)
...
<a id="param_1"></a>
### Please Specify the Please specify Color HEX Value
...
<li>Empty</li>
</ul></dd><dt>Sample Usage</dt><dd><strong>#ff22bb</strong> or <em>ff22bb</em>* or <strong>{vHex}</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
