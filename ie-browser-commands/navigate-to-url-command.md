...
<dl>
<dt>What to input</dt><dd>Enter the unique instance name that was specified in the Create IE Browser command</dd>
<dt>Sample Data</dt><dd>myInstance or IEInstance</dd>
<dt>Remarks</dt><dd>Failure to enter the correct instance name or failure to first call Create IE Browser command will cause an error</dd>
</dl>
