...
## Command Parameters
- [Please Select the Please specify Path to the EMail](#param_0)
- [Please Select the Please specify EMail Variable Name](#param_1)
- [Please Specify the Comment Field (Optional)](#param_2)


<a id="param_0"></a>
### Please Select the Please specify Path to the EMail
...
<li>Empty</li>
</ul></dd><dt>Sample Usage</dt><dd><strong>C:\Temp\mymail.eml</strong> or <strong>{vPath}</strong></dd>
