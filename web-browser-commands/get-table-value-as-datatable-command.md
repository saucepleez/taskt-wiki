...
|Optional - Please Specify Attribute Name to Get (Default is textContent)||**id** or **Text** or **textContent** or **{vAttribute}**||
|Please Specify DataTable Variable Name to store result||||
|Optional - Please Specify the method for the First Row (Default is First Row)||**First Row** or **Column Name** or **Ignore**||
