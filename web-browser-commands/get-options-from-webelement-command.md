...
Web Browser Commands &gt; WebElement Action &gt; Get Options From WebElement
...
<dt>Sample Usage</dt><dd><strong>textContent</strong> or <strong>value</strong> or <strong>{vAttribute}</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
