<!--TITLE: Get An WebElement Values As Dictionary Command -->
<!-- SUBTITLE: a command in the Web Browser Commands group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser Commands &gt; Scraping &gt; Get An WebElement Values As Dictionary


# Get An WebElement Values As Dictionary Command


## What does this command do?
This command allows you to get Attributes value for an WebElement As Dictionary.


## When would I want to use this command?
Use this command when you want to get Attributes value for an WebElement As Dictionary.
...
Automation Class Name: SeleniumBrowserGetAnWebElementValuesAsDictionaryCommand
