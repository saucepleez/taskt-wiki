<!--TITLE: Wait For WebElement Exist Command -->
<!-- SUBTITLE: a command in the Web Browser Commands group. -->
[Go To Automation Commands Overview](/automation-commands.md)


Web Browser Commands &gt; Search &gt; Wait For WebElement Exist


# Wait For WebElement Exist Command
...
Automation Class Name: SeleniumBrowserWaitForWebElementExistCommand
